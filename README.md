...
# 🍵 嗚呼、諸君ヨ！我々ハ今日ハ何ヲ飲ムカ！ · tea-planner MCP

> **ワケモナク一碗ヲ手ニ取リ、茶ヲ愛スル人ヘ贈ル。** —— 白居易
>
> **旧友ト故郷ヲ偲ブノハヤメヨウ、新タナ火デ新茶ヲ試ソウ。詩ト酒ハ、時ガ若イウチニ。** —— 蘇軾

事ノ始マリハコウダ。オ茶ノ在庫ガ増エ続ケ、戸棚ヲ開ケルタビニ5分間ボンヤリ立チ尽クシ、結局一番手近ナ箱ヲ掴ムヨウニナッタ。茶葉ガ湿気ルノハ私ノセイ。選択困難モ私ノセイ。ダカラプログラムニ責任ヲ負ワセタ。

コウシテCherry Studio上デ動クMCP「今日ハドノオ茶ニスル？」ガ生マレタ。107種類ノ茶ノ急須抽出条件（緑茶、烏龍茶、黒茶、紅茶、白茶、黄茶、花茶、ソノ他分類不能ナ変ワリ種）ヲ内蔵シ、毎日**理由ノアル硬貨**ヲ投ゲテクレル。季節、時間帯、最近飲ンダカドウカ、在庫ノ埃カブリ度合イデ重ミ付ケ抽選スル。夏デモ熟普洱ガ当タルコトハアル。タダ確率ガ低イダケ。深夜ニ代用茶バカリヲ押シ付ケルコトモシナイ——規則ハ柔ラカク、死刑判決ヲ受ケルオ茶ハナイ。
...
| `add_tea` | 龍井茶、鉄観音、正山小種ヲ買ッタ（一括登録対応） |
| `remove_tea` | 碧螺春ヲ飲ミ切ッタ |
| `clear_inventory` | 引ッ越シタ（一回操作デ全消去——作者ノ茶櫃ヲ引キ継ガナイ） |
| `set_brewer` | 急須ハ300ml / 水出シ容器ヲ2Lニ変エタ |
| `review` | 薄スギル / 苦イ / 倉庫臭 / 洗茶シスギ / 蒸レ味 / 酸ッパクナッタ / 香リガ飛ンダ |
| `record` / `undo_record` / `history` | 〇〇ヲ飲ンダ / 記録ヲ撤回 / 最近何ヲ飲ンダ？ |
...
Cherry Studio → 設定 → MCPサーバー → コノJSONヲ取込（経路ハ自分ノ環境ニ置キ換エ）：
...
スイッチヲオンニシ、道具一覧ニ11個ノ道具ガ表示サレレバ成功。Windowsユーザーヘノ注意：`command` ニハ python.exe ノ完全経路ヲ書クコト。`WindowsApps` 内ノ0バイトノストア用スタブハ、オ茶デハナク Microsoft Store ヘ連レテ行ッテシマウ。

Pythonヲ入レタクナイ場合ハ、`SKILL.md` ヲ Cherry Studio ノ Skills フォルダニ入レルト、指示文ノミノ代替手段ガ使エル（永続化ハサレナイガ、スグ使エル）。

## 導入後3手順

1. **引ッ越ス**：「引ッ越シタ」ト言ウ → 作者ノ107種類ノオ茶ヲ消去（誤操作防止ノタメ2回確認）
2. **仕入レル**：「龍井茶、大紅袍、熟成白茶ヲ買ッタ」 → 一括登録、条件ハ分類別ニ自動設定
3. **飲ム**：「今日ハ何ヲ飲ム？」 → アトハプログラムガ悩ンデクレル

## 淹レ方ニツイテ（注グ前ニ読ムコト）

**コレハ工夫茶式デハアリマセン。** 蓋碗モ、高速抽出モ、「一煎目ハ香リ、二煎目ハ水、三煎目ハ茶」モアリマセン。作者ガ普段使ッテイルノハ **400mlノ大急須 + 1.6Lノ水出シ容器、TDS20ノ純水**。一度ニ満タシ、4〜5分蒸ラシ、一気ニ注ギ出シテ茶葉ト茶湯ヲ分離スル——茶ノ官能審査ヤ英国式茶壺ニ近イヤリ方デス。スベテノ茶葉量、湯温、時間ハコノ構成ニ合ワセテ調整サレテイマス。

道具ガ違ウ？「急須ハ500ml」ト言エバ、茶葉量ガ茶水比ニ応ジテ自動デ調整サレ、湯温ト時間ハ変ワラナイ。水出シモ同様。

## 評価：オ茶ヲアナタ好ミニ育テル

理論上ノ条件ハ出発点ニスギマセン。販売元ノロット、倉庫デノ年数、保存状態ニヨッテ、オ茶ハ仕様書カラ外レテイキマス。味ガ合ワナイト感ジタラ、ソウ言ッテクダサイ：

- **薄スギル / 濃スギル / 渋イ** → 茶葉量・時間・湯温ヲ自動微調整
- **倉庫臭ガ強イ / 洗茶シスギ** → 洗茶手順ヲ調整（生普洱初期設定：高速洗イ1回＋低速洗イ1回＋2分空気ニ当テル。熟普洱／六堡茶／辺境磚茶：高速洗イ2回＋低速洗イ1回＋2分空気ニ当テル＋高速洗イ1回）
- **蒸レ味 / 香リガ飛ブ** → 蓋ヲスルカ開ケルカ
- **酸ッパクナッタ / 香リガ消エタ** → 湯温ヲ3℃下ゲル
- 調整シスギタラ「〇〇ヲ初期化」ト言エバ、一回操作デ理論値ニ戻ル

スベテノ情報ハスクリプトノ隣ニアル `state.json` ニ保存サレマス。コノファイルヒトツヲ控エトシテ保存スレバ、アナタノ味ノ好ミモ一緒ニ引ッ越セマス。

---

**ゴ参考マデニ。** オ茶ハアナタノオ茶、口ハアナタノ口、条件ハ理論値、ソシテオイシサコソガ正義。プログラムハオ茶ヲ淹レラレマセン。タダ、ソコソコ理屈ノアル硬貨ヲ投ゲルダケデス。
...
# 🍵 今日飲何茶 · tea-planner MCP

> 無由持一碗，寄與愛茶人。——白居易
>
> 休對故人思故國，且將新火試新茶。詩酒趁年華。——蘇軾

惟家中之茶日增，乃至啟櫝茫然，凝立半晌，終取去手最近者。茶受潮，咎在己；擇之難，亦咎在己；不如委其過於程序。遂有此掛於 Cherry Studio 之 MCP，名曰「今日飲何茶」。內置百有七品茶之壺泡參數（綠茶、青茶、黑茶、紅茶、白茶、黃茶、花茶，又有難歸何類之異品若干），每日代君擲一有據之錢：以季節、時辰、邇日飲否、庫藏積塵之久暫，權其輕重而抽籤。盛夏亦或得熟普，特其機微；深夜亦不惟以代用茶相塞——法度柔軟，無一茶遭棄。
